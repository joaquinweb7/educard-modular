...
@section('heading', 'Lista de Carnets')
@section('content')
...
<div class="panel" id="results-container" style="margin-top:18px">
    <div class="actions" style="margin-bottom:12px">
        <a class="btn primary" href="{{ route('admin.carnets.create') }}">Crear nuevo</a>
        <a class="btn" href="{{ route('admin.carnets.subir') }}">Importar Excel</a>
    </div>
        ...
        <tr>
            ...
            <td>
                <div style="display:flex;gap:6px">
                    <a href="{{ route('admin.carnets.edit', $carnet) }}" class="btn secondary sm" style="padding:6px; color:var(--primary); border: 1px solid rgba(79,70,229,0.2)" title="Editar">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg>
                    </a>
                    <form method="POST" action="{{ route('admin.carnets.destroy', $carnet) }}" onsubmit="return confirm('¿Eliminar este carnet?')" style="margin:0">
                        @csrf @method('DELETE')
