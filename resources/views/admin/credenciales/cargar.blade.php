...
@section('heading', 'Carga Masiva de Credencials')
@section('content')
    ...
    <div class="public-card">
        ...
        <div class="alert info">
            ...
            <div style="margin-top: 15px;">
                <a href="{{ route('admin.credenciales.descargar.plantilla') }}" class="btn secondary sm">
        ...
        <form action="{{ route('admin.credenciales.subir') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="field">
            ...
            <div class="actions" style="margin-top: 30px; display: flex; gap: 10px; justify-content: flex-end;">
                <a href="{{ route('admin.credenciales.index') }}" class="btn secondary">Volver</a>
